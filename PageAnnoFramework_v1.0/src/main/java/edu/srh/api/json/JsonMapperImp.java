...
import edu.srh.jsoncore.Body;
import edu.srh.jsoncore.Creator;
import edu.srh.jsoncore.Creator_;
import edu.srh.jsoncore.EndSelector;
import edu.srh.jsoncore.Generator;
import edu.srh.jsoncore.Item;
import edu.srh.jsoncore.Source;
import edu.srh.jsoncore.StartSelector;
import edu.srh.jsoncore.Stylesheet;
import edu.srh.jsoncore.Target;
...
public class JsonMapperImp implements JsonMapper {
	...
	private RDFObject getSourceType(Source source) throws AnnotationExceptions {
		try {
			edu.srh.api.Source sourceObj = anno4j.createObject(edu.srh.api.Source.class);
	 ...
	 * @throws AnnotationExceptions
	 */
	private Selector getSelector(edu.srh.jsoncore.Selector selector) throws AnnotationExceptions {
		try {
